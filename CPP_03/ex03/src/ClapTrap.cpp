...
/*   Updated: 2023/03/06 15:01:31 by pcampos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	if(this->_hp > 0)
		std::cout << "Unit " << this->_name << " has taken " << amount << " points of damage!" << std::endl;
	else
		std::cout << "Unit " << this->_name << " has taken lethal amount of damage and died!" << std::endl;
}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	this->_ep--;
	this->_hp += amount;
	std::cout << "Unit " << this->_name << " recovered " << amount << " health points!" << std::endl;
}